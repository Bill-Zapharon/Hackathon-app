  ...
  return (
    <div className="text-center px-6 sm:px-12 lg:px-24">
      <h1 className="text-4xl font-light text-gray-700 mb-12 mt-12">
        Une question, une idée ? Nous sommes là pour vous accompagner dans votre
        aventure de tontine en ligne !
      </h1>
      <div className="mx-auto mt-16 max-w-7xl sm:mt-20 lg:mt-24">
        <dl className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="flex flex-col items-center">
              <div className="p-6 bg-white rounded-lg shadow-lg flex flex-col items-center w-full">
                {feature.icon}
                ...
                {feature.end && (
                  <dd className="text-blue-700 mt-5 font-semibold">
                    {feature.end}
                  </dd>
                )}
              </div>
